...
day02 : Test
day02 =
    describe "It fulfills the goals of day 2"
        [ describe "Part one"
            [ test "It correctly calculates the checksum" <|
                \_ ->
                    """
                     5 1 9 5
                     7 5 3
        ...
        , describe "Part two"
            [ test "It calculates the checksum" <|
                \_ ->
                    """
                    5 9 2 8
                    9 4 7 3
        ...
        , describe "Problem"
            [ test "It solves the problem" <|
                ...
                1311 64 77 1328 1344 1248 1522 51 978 1535 1142 390 81 409 68 352"""
                    in
                        Expect.all
                            [ partOne >> Expect.equal 39126
                            , partTwo >> Expect.equal 258
                            ]
                            input
            ]
        ]
