...
let () =
  ...
  describe "Problem" (fun () ->
      let input = {|
                ...
                1311	64	77	1328	1344	1248	1522	51	978	1535	1142	390	81	409	68	352|} in
      test "It solves part one" (fun () ->
            expect (part_one input) |> toBe 39126
        );
      test "It solves part two" (fun () ->
            expect (part_two input) |> toBe 258
        );
